...
ggsave(fig, file="Figure_S_Nathan_1.pdf", height=30, width=12)

fig = plot_grid(plotlist = unlist(figList[17:29]), ncol=4)
ggsave(fig, file="Figure_S_Nathan_2.pdf", height=27, width=12)
```
