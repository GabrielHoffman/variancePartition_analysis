...
ggsave(fig, file="Figure_S_OneK1K_1.pdf", height=30, width=12)

fig = plot_grid(plotlist = unlist(figList[17:23]), ncol=4)
ggsave(fig, file="Figure_S_OneK1K_2.pdf", height=18, width=12)
```
